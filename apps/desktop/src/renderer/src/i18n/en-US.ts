...
export const enUS = {
  ...
  'home.section.usage': 'Usage This Week',
  ...
  'home.empty.usage': 'No usage recorded this week.',
  ...
  'accounts.usage.recent': 'Usage 24h: {day} · 7d: {week}',
  'usage.cost.notReported': 'Not reported',
  'usage.run.summary': '{input} in · {output} out · Cost: {cost}',
